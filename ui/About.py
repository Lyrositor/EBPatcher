...
"}"))
        ...
        self.About = QtGui.QLabel(Dialog)
...
"}"))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.About.setText(QtGui.QApplication.translate("Dialog", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">EarthBound Patcher</span></p><p><span style=\" font-style:italic;\">Created by Lyrositor.</span></p><p><a href=\"https://github.com/Lyrositor/EBPatcher\"><span style=\" text-decoration: underline; color:#4b4b4b;\">https://github.com/Lyrositor/EBPatcher</span></a></p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.GetMore.setText(QtGui.QApplication.translate("Dialog", "Get more patches online", None, QtGui.QApplication.UnicodeUTF8))
